...
Never rely on just one piece of data, it can be misleading. Always include _fundamental analysis_ alongside _technical analysis_. Be careful not to miss the news and fundamental analysis. 
